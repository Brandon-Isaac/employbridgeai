...
function ApplicationsComponent_td_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 18)(1, "div", 20);
    \u0275\u0275element(2, "i", 21);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(5, 1, application_r5.appliedDate, "mediumDate"));
  }
}
...
function ApplicationsComponent_td_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ApplicationsComponent_td_21_Template_button_click_4_listener() {
      const application_r8 = \u0275\u0275restoreView(_r7).$implicit;
      const ctx_r1 = \u0275\u0275nextContext();
...
var ApplicationsComponent = class _ApplicationsComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ApplicationsComponent, selectors: [["app-applications"]], decls: 24, vars: 5, consts: [[1, "applications-container"], [1, "elevated-card"], [1, "typewriter"], ["mat-table", "", 1, "mat-elevation-z2", "applications-table", 3, "dataSource"], ["matColumnDef", "jobTitle"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-cell", "", 3, "mouseenter", "mouseleave", 4, "matCellDef"], ["matColumnDef", "company"], ["mat-cell", "", 4, "matCellDef"], ["matColumnDef", "appliedDate"], ["matColumnDef", "status"], ["matColumnDef", "actions"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", 3, "mouseenter", "mouseleave", 4, "matRowDef", "matRowDefColumns"], ["mat-header-cell", ""], ["mat-cell", "", 3, "mouseenter", "mouseleave"], [1, "job-title"], [1, "company-mobile"], ["mat-cell", ""], [1, "company-desktop"], [1, "date-container"], [1, "fas", "fa-calendar-alt", "date-icon"], ["selected", "", 1, "status-chip"], [1, "actions-container"], ["mat-icon-button", "", "matTooltip", "View Details", 1, "view-button", 3, "click"], [1, "fas", "fa-eye"], ["mat-icon-button", "", "matTooltip", "Withdraw", 1, "withdraw-button", 3, "click"], [1, "fas", "fa-trash-alt"], ["mat-header-row", ""], ["mat-row", "", 3, "mouseenter", "mouseleave"]], template: function ApplicationsComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275template(14, ApplicationsComponent_th_14_Template, 2, 0, "th", 5)(15, ApplicationsComponent_td_15_Template, 6, 4, "td", 8);
      \u0275\u0275elementContainerEnd();
      ...
      \u0275\u0275template(20, ApplicationsComponent_th_20_Template, 2, 0, "th", 5)(21, ApplicationsComponent_td_21_Template, 6, 0, "td", 8);
      \u0275\u0275elementContainerEnd();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ApplicationsComponent, { className: "ApplicationsComponent", filePath: "src/app/job-seeker/components/applications/applications.component.ts", lineNumber: 363 });
})();
export {
  ApplicationsComponent
};
//# sourceMappingURL=chunk-5I4NYFYT.js.map
