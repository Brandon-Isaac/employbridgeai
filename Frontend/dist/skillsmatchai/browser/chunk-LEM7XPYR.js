...
function ChatbotComponent_div_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(6, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(7, ChatbotComponent_div_9_mat_progress_bar_7_Template, 1, 0, "mat-progress-bar", 15);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var ChatbotComponent = class _ChatbotComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ChatbotComponent, selectors: [["app-chatbot"]], decls: 20, vars: 3, consts: [[1, "chatbot-container"], [1, "chatbot-card"], [1, "chat-content"], [1, "messages-container"], [3, "class", 4, "ngFor", "ngForOf"], [1, "suggested-queries"], [3, "click", 4, "ngFor", "ngForOf"], [1, "input-container"], ["appearance", "outline", 1, "full-width"], ["matInput", "", "placeholder", "e.g., Show me my skill progress", 3, "ngModelChange", "keyup.enter", "ngModel"], ["mat-icon-button", "", "matSuffix", "", 3, "click"], [1, "fas", "fa-paper-plane"], [1, "message-content"], [1, "message-text"], [1, "message-time"], ["mode", "indeterminate", 4, "ngIf"], ["mode", "indeterminate"], [3, "click"]], template: function ChatbotComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ChatbotComponent, { className: "ChatbotComponent", filePath: "src/app/job-seeker/components/chatbot/chatbot.component.ts", lineNumber: 180 });
})();
export {
  ChatbotComponent
};
//# sourceMappingURL=chunk-LEM7XPYR.js.map
